  ...
  return (
      ...
      >
        ...
        <div className="w-full flex flex-col justify-center items-center gap-4 mt-8">
          <p className="text-2xl text-[#c5a56f] font-philosop ">
            Welcome to Hotel TNC
          </p>
          <p className="text-5xl sm:text-6xl md:text-7xl font-philosop text-white w-4/5 md:w-[750px] text-center">
            Where Every Moment Feels Like Home
          </p>
          <p className="text-sm md:text-lg text-white text-center font-philosop w-4/5 md:w-[47%] ">
            At Hotel TNC, we invite you to experience a haven of serenity amidst
